...
function draw() {
  ...
  for (let r = 0; r < ROWS; r++) {
    for (let c = 0; c < COLS; c++) {
      ...
      if (cell.isStart) ctx.fillStyle = '#4caf50';
      else if (cell.isEnd) ctx.fillStyle = '#f44336';
      else if (cell.isPath) ctx.fillStyle = '#ffeb3b';
      else if (cell.isObstacle) ctx.fillStyle = '#333';
      else if (cell.isVisited) ctx.fillStyle = '#90caf9';
